...
User.destroy_all
10.times do
    User.create(username: Faker::Name.first_name, first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, photo: rand(1..10))
end
...
Comment.destroy_all
30.times do
    Comment.create(user_id: User.all.ids.sample, post_id: Post.all.ids.sample)
end
